...
export default function MapSelectDialog({ open, onClose, serverId, serverGotoLink }: MapSelectDialogProps) {
    ...
    const handleMapSelect = (mapName: string) => {
        onClose();
        router.push(`/servers/${serverGotoLink}/maps/${mapName}/guides/new`);
    };
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Choose a map to create a guide for
                    </DialogDescription>
                </DialogHeader>
