...
import { FileText, MessageSquare, Music, Ban, Shield, Megaphone, Bell, Settings, Box, Heart, Settings2 } from 'lucide-react';
...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Map Metadata', href: '/admin/map-metadata', icon: Settings2 },
